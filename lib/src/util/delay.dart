...
/// A utility class for handling delays with optional cancellation and callbacks.
class Delay<F> {
  ...
  /// Starts the delay and executes the callback after the duration, unless canceled.
